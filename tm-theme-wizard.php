...
if ( ! class_exists( 'TM_Theme_Wizard' ) ) {
	...
	class TM_Theme_Wizard {
		...
		public function lang() {
			load_plugin_textdomain( 'tm-theme-wizard', false, $this->path( 'languages' ) );
		}
